...
from general_setup import fetch_all_data,good_XXth_days_year,good_XX_days_of_year,bad_XXth_days_of_year,bad_nth_days_of_year,bad_XX_days_of_year,old_style_days_of_year
...
# Fetch old-style data
old_style_data = fetch_all_data(old_style_days_of_year)
old_style_data = old_style_data[['year'] + [col for col in old_style_days_of_year if col in old_style_data.columns]]
old_style_data.to_csv('old_style_data.csv', index=False)
